 ...
 * override the drawFrame method. This method is responsible for drawing one
 * frame of the animation. If you want to customize the animation, with calls to
 ...
 * start(), stop(), ane destroy(), without calling the versions defined below in
 * the SimpleAnimationApplet class.
 * 
 * (Alternatively, instead of defining a subclass, you could copy this file,
 * change its name, and edit it.)
 * 
 * This applet is compatible with Java version 1.2 or later. It has the same
 * functionality as an older program SimpleAnimationApplet.java, which was
 * written in Java 1.0 and works with any version of Java.
 * 
 * David Eck Department of Mathematics and Computer Science Hobart and William
 * Smith Colleges Geneva, NY 14456 eck@hws.edu
 * 
 * May 15, 2002
 */
...
public class SimpleAnimation2 extends JPanel implements ActionListener
{
    ...
    public int getFrameNumber()
    {
        ...
        // (If frameCount is greater than zero, and if frameNumber is greater
        // than
